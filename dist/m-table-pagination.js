...
function (_React$Component) {
  ...
  function MTablePaginationInner() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleFirstPageButtonClick", function (event) {
      _this.props.onChangePage(event, 0);
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleBackButtonClick", function (event) {
      _this.props.onChangePage(event, _this.props.page - 1);
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleNextButtonClick", function (event) {
      _this.props.onChangePage(event, _this.props.page + 1);
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleLastPageButtonClick", function (event) {
  ...
  (0, _createClass2.default)(MTablePaginationInner, [{
    ...
    value: function render() {
      ...
      }, React.createElement(this.props.icons.FirstPage, null)))), React.createElement(_core.Tooltip, {
        title: localization.previousTooltip
      }, React.createElement("span", null, React.createElement(_core.IconButton, {
        onClick: this.handleBackButtonClick,
        disabled: page === 0,
        "aria-label": localization.previousAriaLabel
      }, React.createElement(this.props.icons.PreviousPage, null)))), React.createElement(_core.Tooltip, {
        title: localization.nextTooltip
      }, React.createElement("span", null, React.createElement(_core.IconButton, {
        onClick: this.handleNextButtonClick,
        disabled: page >= Math.ceil(count / rowsPerPage) - 1,
        "aria-label": localization.nextAriaLabel
      }, React.createElement(this.props.icons.NextPage, null)))), React.createElement(_core.Tooltip, {
